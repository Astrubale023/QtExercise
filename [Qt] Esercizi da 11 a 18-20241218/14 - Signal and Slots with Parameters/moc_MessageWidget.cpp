...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MessageWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MessageWidget_t qt_meta_stringdata_MessageWidget = {
    {
        QT_MOC_LITERAL(0, 13),  // "MessageWidget"
        QT_MOC_LITERAL(14, 11),  // "updateLabel"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "MessageWidget",
    "updateLabel",
...
Q_CONSTINIT static const uint qt_meta_data_MessageWidget[] = {
...
Q_CONSTINIT const QMetaObject MessageWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MessageWidget.offsetsAndSizes,
    qt_meta_data_MessageWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MessageWidget_t,
        // Q_OBJECT / Q_GADGET
